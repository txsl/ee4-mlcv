...
for T = 1:param.num
    ...
    idx = randsample(N, N, true); % A training set for each tree is generated by random sampling from dataset WITH replacement.
    prior = histc(data(idx,end),labels)/sum(idx);
