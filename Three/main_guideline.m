...
for T = 1:4
    idx = ...; % index of a data subset for each tree is generated by random sampling from dataset WITH replacement.
...
for n = 1:3
    ...
    idx_ = ...;            % idx_: index of data going to the left-child node by chosen dimension and threshold
